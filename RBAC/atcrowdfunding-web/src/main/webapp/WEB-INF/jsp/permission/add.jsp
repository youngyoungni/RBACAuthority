			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" name="loginacct" class="form-control" id="permissionname" placeholder="请输入许可名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">链接地址</label>
					<input type="text" name="username" class="form-control" id="url" placeholder="请输入链接地址">
				  </div>
			    ...
			    $("#insertBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		success	: function(result){
			    			...
			    			if( result.success ){
			    				layer.msg("许可信息新增成功", {time:1000, icon:1 ,shift:2}, function(){
				    				window.location.href = "${APP_PATH}/permission/index";
			    				});	
			    			}else{
			    				layer.msg("许可信息新增失败，请重新操作", {time:1000, icon:5, shift:2}, function(){
		    					});	
			    			}
			    		}
			    	});
