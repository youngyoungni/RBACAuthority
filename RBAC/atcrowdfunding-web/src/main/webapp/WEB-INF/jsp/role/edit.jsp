			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="name" name="name" value="${role.name }" placeholder="请输入名称">
				  </div>
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		success : function(result){
			    			...
			    			if( result.success){
			    				layer.msg("角色信息修改成功", {time:1000, icon:1 ,shift:2}, function(){
				    				window.location.href = "${APP_PATH}/role/index";
			    				});	
			    			}else{
			    				layer.msg("角色信息修改失败，请重新操作", {time:1000, icon:5, shift:2}, function(){
		    					});	
			    			}
			    		},
